...
public class SmartTeamTrackingApplicationOLD {
	
	static ApplicationContext context;
	static Logger log = Logger.getLogger(SmartTeamTrackingApplicationOLD.class.getSimpleName());
	...
	public static void main(String[] args) {
		...
		context = SpringApplication.run(SmartTeamTrackingApplicationOLD.class, args);
