...
+ [x] **DONE** Avoid sending unused data by REST calls 
+ [x] **DONE** Website for adding beacons to the system 
+ [x] **DONE** Improve and Debug Android Application 
+ [x] **DONE** Add REST calls for removing groups and to be able to leave a created group 
